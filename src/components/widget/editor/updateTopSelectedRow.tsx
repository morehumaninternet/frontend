...
export default function updateTopSelectedRow(issueBodyRef: React.MutableRefObject<HTMLDivElement>, topSelectedRow: null | { top: number, left: number, right: number }) {
