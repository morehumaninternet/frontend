...
function CenteredLogo(): JSX.Element {
  return (
    <svg width={71} height={109} viewBox="0 0 71 109" fill="none" className="header-logo against-hero">
      <path d="M21.99 13.937a4.74 4.74 0 004.734-4.736 4.74 4.74 0 00-4.734-4.733A4.74 4.74 0 0017.255 9.2a4.74 4.74 0 004.735 4.736z" className="left-head" />
      <path d="M33.581 5.09a5.095 5.095 0 005.09 5.09 5.095 5.095 0 005.09-5.09A5.095 5.095 0 0038.67 0a5.095 5.095 0 00-5.09 5.09z" className="right-head" />
      <path
  ...
  React.useEffect(
    () => {
      ...
      function onScroll(): void {
        ...
        // Fade from white to blue when hitting .post-sky2 as that element has a white background
        const postSky2Top = postSky2Ref.current!.getBoundingClientRect().top
        const pixelsUntilPostSky2 = postSky2Top - headerBottom
